...
<p align="center">
<a href="https://github.com/ethpandaops/blob-testnet/actions/workflows/ansible_lint.yaml"><img src="https://github.com/ethpandaops/blob-testnet/actions/workflows/ansible_lint.yaml/badge.svg"></a>
<a href="https://github.com/ethpandaops/blob-testnet/actions/workflows/terraform_lint.yaml"><img src="https://github.com/ethpandaops/blob-testnet/actions/workflows/terraform_lint.yaml/badge.svg"></a>
<a href="https://github.com/ethpandaops/blob-testnet/actions/workflows/helm_lint.yaml"><img src="https://github.com/ethpandaops/blob-testnet/actions/workflows/helm_lint.yaml/badge.svg"></a>
</p>
...
## Ansible
To install the nodes according to the inventory file that is generated by the terraform blob run the following commands from [`./ansible/`](./ansible/)
```shell
